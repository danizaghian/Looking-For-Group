...
game6 = Game.create(name: "Super Smash Bros.", min_players: 1, max_players: 16, description: "Duke it out with your favorite nintendo characters!", picture: "/images/mario.png")
game7 = Game.create(name: "Street Fighter", min_players: 1, max_players: 2, description: "The Original fighter", picture: "/images/sf-logo.png")
game8 = Game.create(name: "Puzzle Fighter", min_players: 1, max_players: 2, description: "Gem-destroying Fun!", picture: "/images/ryu_white.png")
game9 = Game.create(name: "Mario Kart 8", min_players: 1, max_players: 12, description: "Karma is when you throw a banana in Mario Kart and you end up slipping on it", picture: "/images/mario-kart.png")
